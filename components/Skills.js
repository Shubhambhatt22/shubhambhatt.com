            ...
            <div className="row">
              ...
              <div className="col-xl-6 mil-mb-40">
                <div className="mil-text-row">
                  ...
                  <div className="mil-progress-inline">
                    <span className="mil-upper">React Flow</span>
                    <div className="mil-progress-track">
                      <div className="mil-progress" style={{ width: "75%" }}>
                        <span className="mil-upper mil-upper-sm mil-accent">
                          75%
              ...
              <div className="col-xl-6 mil-mb-40">
                <div className="mil-text-row">
                  ...
                  <div className="mil-progress-inline">
                    <span className="mil-upper">Redux Toolkit</span>
                    <div className="mil-progress-track">
                      <div className="mil-progress" style={{ width: "75%" }}>
                        <span className="mil-upper mil-upper-sm mil-accent">
                          75%
              ...
              <div className="col-xl-6 mil-mb-40">
                <div className="mil-text-row">
                  ...
                  <div className="mil-progress-inline">
                    <span className="mil-upper">Ant Design(AntD)</span>
                    <div className="mil-progress-track">
                      <div className="mil-progress" style={{ width: "75%" }}>
                        <span className="mil-upper mil-upper-sm mil-accent">
                          75%
              ...
              <div className="col-xl-6 mil-mb-40">
                <div className="mil-text-row">
                  ...
                  <div className="mil-progress-inline">
                    <span className="mil-upper">Tailwind CSS</span>
                    <div className="mil-progress-track">
                      <div className="mil-progress" style={{ width: "75%" }}>
                        <span className="mil-upper mil-upper-sm mil-accent">
                          75%
